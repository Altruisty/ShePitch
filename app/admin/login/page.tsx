...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1a0c27] via-[#2d1545] to-[#12051c] flex items-center justify-center p-4 relative overflow-hidden">
      {/* Glow Effects */}
      ...
      <div className="max-w-md w-full relative z-10">
        <div className="text-center mb-8 space-y-2">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 text-[#E83E8C] mb-2 shadow-xl">
            <ShieldCheck className="w-9 h-9" />
          </div>
          <h1 className="text-3xl font-extrabold text-white tracking-tight">ShePitch Admin</h1>
          <p className="text-gray-400 text-sm">Authorized Portal Access & Management</p>
        </div>
