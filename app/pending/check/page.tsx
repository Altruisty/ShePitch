...
export default function PendingCheckPage() {
  ...
  const [customPaymentId, setCustomPaymentId] = useState('pay_TZPiMnNgHTkm4Y');
  const [customAmount, setCustomAmount] = useState('897');
    ...
    <div className="min-h-screen py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8">
          ...
          <div className="mt-6 pt-6 border-t border-gray-200/80">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                ...
                <input
                  type="text"
                  placeholder="e.g. Miss spark or thejesvanisivakumar@gmail.com"
                  value={searchQuery}
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="pay_TZPiMnNgHTkm4Y"
        ...
        <div className="flex items-center gap-3.5">
          ...
          <div>
            ...
            <div className="text-sm font-extrabold text-gray-900">
              Miss spark • Prathyusha Engineering College (Project Pitch)
            </div>
            <div className="text-xs text-gray-600">
              Leader: <span className="font-semibold text-gray-800">S.Thejesvani</span> (thejesvanisivakumar@gmail.com) • Payment ID: <span className="font-mono font-semibold text-purple-700">pay_TZPiMnNgHTkm4Y</span> (₹897.00)
            </div>
          </div>
        </div>
      ...
      <div className="bg-[#0f172a] rounded-3xl border border-slate-800 shadow-2xl overflow-hidden font-mono text-xs">
        ...
        <div className="bg-[#1e293b]/60 px-4 py-2 border-t border-slate-800/80 flex items-center justify-between text-[11px] text-slate-400">
          <span>Target Payment ID: pay_TZPiMnNgHTkm4Y</span>
      ...
      <div className="bg-white rounded-3xl p-6 border border-gray-200 shadow-sm space-y-3">
        ...
        <ol className="list-decimal list-inside text-xs text-gray-600 space-y-1.5 leading-relaxed">
          <li>
            Commit and push these two files to your GitHub repository:
          ...
          <li>
            The page will automatically load, connect to your production database, find team{' '}
            <span className="font-bold text-gray-800">Miss spark</span>, update their payment status from{' '}
            ...
            <span className="font-mono text-purple-700 font-bold">pay_TZPiMnNgHTkm4Y</span>, and dispatch the official confirmation email to{' '}
            <span className="font-semibold text-gray-800">thejesvanisivakumar@gmail.com</span>.
          </li>
          <li>
