        ...
        >
          ...
          <div className="space-y-6">
            <div className="flex items-start sm:items-center justify-between gap-4 flex-wrap sm:flex-nowrap">
              ...
              <div className={`inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full shadow-sm shrink-0 ${
                ...
                <span className="text-xs sm:text-sm font-extrabold tracking-wide">
                  {availability.ideaOpen ? `${availability.ideaTeamsLeft} Slots Left` : 'Registration Closed'}
                </span>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="flex items-start sm:items-center justify-between gap-4 flex-wrap sm:flex-nowrap">
              ...
              <div className={`inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full shadow-sm shrink-0 ${
                ...
                <span className="text-xs sm:text-sm font-extrabold tracking-wide">
                  {availability.projectOpen ? `${availability.projectTeamsLeft} Slots Left` : 'Registration Closed'}
                </span>
              </div>
            </div>
